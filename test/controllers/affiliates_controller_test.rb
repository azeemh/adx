...
class AffiliatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affiliate" do
    assert_difference('Affiliate.count') do
      post affiliates_url, params: { affiliate: { affid: @affiliate.affid, name: @affiliate.name } }
    end
  ...
  test "should update affiliate" do
    patch affiliate_url(@affiliate), params: { affiliate: { affid: @affiliate.affid, name: @affiliate.name } }
